...
chrome-use tab close                        # Close current session-created tab
chrome-use tab close t2                     # Close a session-created tab by id
chrome-use tab close docs                   # Close a session-created tab by label
