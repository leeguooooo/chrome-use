...
const MAP = [
  ...
  { test: /^skill-data\/real-chrome\//,    pages: ['real-chrome'] },
  { test: /^skill-data\/network\//,        pages: ['network'] },
  { test: /^skill-data\/sessions\//,       pages: ['sessions'] },
  { test: /^skill-data\/react\//,          pages: ['react'] },
